 ...
 public class AntLabMain {
    ...
    public void printOutMessage() {
        ...
        String toPrint =
		  ...
		  Person1 p1 = new Person1("Miguel");
		  toPrint += p1.toString("moller3");
		  //Person2 replace P2 with your name
		  //and gburdell with your gt id
		  Person2 p2 = new Person2("Fuad");
		  toPrint += p2.toString("fhasbun3");
		  //Person3 replace P3 with your name
		  //and gburdell3 with your gt id
		  Person3 p3 = new Person3("Rohan Avalani");
		  toPrint += p3.toString("ravalani3");
                  //Person4 replace P4 with your name
                  //and gburdell4 with your gt id
                  Person4 p4 = new Person4("Bhaskar Khaneja");
                  toPrint += p4.toString("bkhaneja3");
                  //Person5 replace P5 with your name
                  //and gburdell5 with your gt id
                  Person5 p5 = new Person5("Ricardo De Andrade");
                  toPrint += p5.toString("randrade6");
